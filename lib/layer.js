...
var createHanlder = module.exports = function(res, options) {
    ...
    var load = function(id, async) {
        ...
        if (loaded[id] && !async) {
            ...
            console.log('>>>weg load id:' + id + ' info:' + JSON.stringify(info));
    ...
    return {
        ...
        addScript: function (script) {
            //console.log('>>>weg addscript:' + script);
            scripts.push(script);
        },
